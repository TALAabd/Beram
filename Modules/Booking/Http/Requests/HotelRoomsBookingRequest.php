...
class HotelRoomsBookingRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'check_in_date' => 'nullable|date_format:Y-m-d H:i:s|after_or_equal:today',
            'check_out_date' => 'nullable|date_format:Y-m-d H:i:s|after:check_in_date',
            ...
            'rooms.*.rooms_count' => 'required|integer|min:1',
        ];
